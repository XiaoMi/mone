...
public class HttpClientV6 {
    ...
    public static String put(String url, String body, Map<String, String> headers) {
        return put(url, body.getBytes(), headers, 500);
    }

    public static String put(String url, String body, Map<String, String> headers, int timeout) {
        return put(url, body.getBytes(), headers, timeout);
    }

    public static String put(String url, byte[] body, Map<String, String> headers, int timeout) {
    ...
    public static HttpResult httpDelete(String url, Map<String, String> headers, Map<String, String> paramValues, String encoding, int readTimeout) {
        List<String> list = Lists.newArrayList();
        if (null != headers) {
            headers.entrySet().stream().forEach(it -> {
                list.add(it.getKey());
        ...
        return request(url, list, paramValues, encoding, "DELETE", readTimeout, false, null);
    }
    ...
    public static HttpResult httpPut(String url, Map<String, String> headers, String body, String encoding, int readTimeout) {
        ...
        return request(url, list, paramValues, encoding, "PUT", readTimeout, false, null);
    }

    public static HttpResult httpPut(String url, byte[] body, Map<String, String> headers, int timeout) {
        HttpURLConnection conn = null;
        ...
        try {
            ...
            logger.warn("http client v2 error:{}", var12.getCause());
    ...
    public static HttpResult httpPost(String url, byte[] body, Map<String, String> headers, int timeout) {
        HttpURLConnection conn = null;
    ...
    public static HttpResult httpPost(String url, Map<String, String> headers, String body, String encoding, int readTimeout) {
        ...
        return request(url, list, paramValues, encoding, "POST", readTimeout, false, null);
    }
