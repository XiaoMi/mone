...
import run.mone.raft.common.HttpHeaderConsts;
import run.mone.raft.common.HttpMethod;
...
public class HttpClient {
    ...
    public static HttpResult request(String url, List<String> headers, Map<String, String> paramValues, String body, int connectTimeout,
        ...
        try {
            ...
            log.warn("Exception while request: {}, caused: {}", url, e);
    ...
    private static void setHeaders(HttpURLConnection conn, List<String> headers, String encoding) {
        ...
        conn.addRequestProperty(HttpHeaderConsts.CLIENT_VERSION_HEADER, "0.0.1");
