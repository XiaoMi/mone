...
public class SwitchDomain implements Record, Cloneable {
    ...
    public AtomicInteger enableService = new AtomicInteger(2);

    public static int ES_LEVEL1 = 1;
    public static int ES_LEVEL2 = 2;
    public static int ES_LEVEL3 = 3;
    public static int ES_LEVEL4 = 4;

    public static AtomicBoolean dbeat= new AtomicBoolean(true);

    public static AtomicBoolean dcheckSums = new AtomicBoolean(true);

    public static AtomicBoolean dsyncData = new AtomicBoolean(true);

    public static AtomicBoolean dgetData = new AtomicBoolean(true);
    ...
    private long clientBeatInterval = TimeUnit.SECONDS.toMillis(10);

    private long defaultCacheMillis = TimeUnit.SECONDS.toMillis(9);
    ...
    private boolean sendBeatOnly = true;
    ...
    public static String moneAgent = "mone";
