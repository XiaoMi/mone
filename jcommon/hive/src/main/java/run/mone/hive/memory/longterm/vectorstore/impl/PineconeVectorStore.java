...
@Slf4j
@Data
public class PineconeVectorStore implements VectorStoreBase {
    private final VectorStoreConfig config;
    
    public PineconeVectorStore(VectorStoreConfig config) {
        this.config = config;
    }
    
    @Override
    public void insert(List<List<Double>> vectors, List<String> ids, List<Map<String, Object>> payloads) {
        throw new UnsupportedOperationException("Pinecone implementation coming soon");
    }
