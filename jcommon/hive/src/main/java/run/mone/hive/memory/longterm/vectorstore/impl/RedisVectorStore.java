...
@Slf4j
@Data
public class RedisVectorStore implements VectorStoreBase {
    private final VectorStoreConfig config;
    
    public RedisVectorStore(VectorStoreConfig config) {
        this.config = config;
    }
    
    @Override
    public void insert(List<List<Double>> vectors, List<String> ids, List<Map<String, Object>> payloads) {
        throw new UnsupportedOperationException("Redis implementation coming soon");
    }
