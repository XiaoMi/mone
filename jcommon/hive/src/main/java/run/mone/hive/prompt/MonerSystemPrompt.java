...
public class MonerSystemPrompt {
    ...
    public static final String MCP_PROMPT = """
            ...
            ## chat
            Description: A tool for handling general conversations and chat interactions. Use this when the user's input is conversational and doesn't require specific functional tools.
            ...
            **If splitting, adhere to these strict rules:**
            ...
            Usage (Attention: If you are using this tool, you MUST return the message(s) in Chinese 中文):
