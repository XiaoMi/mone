...
public class JsonRpcTypes {
    ...
    public record SendTaskStreamingResponse(
        ...
        public TaskEvents.TaskStatusUpdateEvent getStatusResult() {
            return (result instanceof TaskEvents.TaskStatusUpdateEvent) ? (TaskEvents.TaskStatusUpdateEvent) result : null;
        }
        
        public TaskEvents.TaskArtifactUpdateEvent getArtifactResult() {
    ...
    public record SetTaskPushNotificationResponse(
        @JsonProperty("jsonrpc") String jsonrpc,
        @JsonProperty("id") String id,
        @JsonProperty("result") TaskParams.TaskPushNotificationConfig result,
        @JsonProperty("error") JsonRpcError error
    ) {
