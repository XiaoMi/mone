...
@Slf4j
@Data
public class AzureOpenAiLLM implements LLMBase {
    private final LlmConfig config;
    
    public AzureOpenAiLLM(LlmConfig config) {
        this.config = config;
        validateConfig();
    }
    ...
    public String generateResponse(List<Map<String, Object>> messages, String responseFormat) {
        throw new UnsupportedOperationException("Azure OpenAI LLM implementation coming soon");
    }
}
