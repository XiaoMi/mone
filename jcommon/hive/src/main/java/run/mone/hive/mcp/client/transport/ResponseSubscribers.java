...
public class ResponseSubscribers {
    ...
    public sealed interface ResponseEvent permits SseResponseEvent, AggregateResponseEvent, DummyEvent {

        ResponseInfo responseInfo();

    }

    public record DummyEvent(ResponseInfo responseInfo) implements ResponseEvent {

    }

    public record SseResponseEvent(ResponseInfo responseInfo, SseEvent sseEvent) implements ResponseEvent {
    }

    public record AggregateResponseEvent(ResponseInfo responseInfo, String data) implements ResponseEvent {
    }
    ...
    public static BodySubscriber<Void> aggregateBodySubscriber(ResponseInfo responseInfo, FluxSink<ResponseEvent> sink) {
        return HttpResponse.BodySubscribers
            .fromLineSubscriber(FlowAdapters.toFlowSubscriber(new AggregateSubscriber(responseInfo, sink)));
    }

    public static BodySubscriber<Void> bodilessBodySubscriber(ResponseInfo responseInfo, FluxSink<ResponseEvent> sink) {
        return HttpResponse.BodySubscribers
