...
@Slf4j
@Data
public class TogetherEmbedding implements EmbeddingBase {
    private final EmbedderConfig config;
    
    public TogetherEmbedding(EmbedderConfig config) {
        this.config = config;
        validateConfig();
    }
    ...
    public List<Double> embed(String text, String memoryAction) {
        throw new UnsupportedOperationException("Together AI embedding implementation coming soon");
    }
