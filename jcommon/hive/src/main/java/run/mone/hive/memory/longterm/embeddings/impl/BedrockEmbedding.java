...
@Slf4j
@Data
public class BedrockEmbedding implements EmbeddingBase {
    private final EmbedderConfig config;
    
    public BedrockEmbedding(EmbedderConfig config) {
        this.config = config;
        validateConfig();
    }
    ...
    public List<Double> embed(String text, String memoryAction) {
        throw new UnsupportedOperationException("AWS Bedrock embedding implementation coming soon");
    }
