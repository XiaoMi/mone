...
@Slf4j
@Data
public class WeaviateVectorStore implements VectorStoreBase {
    private final VectorStoreConfig config;
    
    public WeaviateVectorStore(VectorStoreConfig config) {
        this.config = config;
    }
    
    @Override
    public void insert(List<List<Double>> vectors, List<String> ids, List<Map<String, Object>> payloads) {
        throw new UnsupportedOperationException("Weaviate implementation coming soon");
    }
