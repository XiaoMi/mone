...
package com.xiaomi.youpin.codecheck.code.impl.classcheck;
...
import com.xiaomi.youpin.codecheck.common.Value;
 ...
 * 会check每个方法
 */
public class ClassPasswordCheck extends ClassCheck {
    ...
    public void checkPassword(JCTree.JCMethodDecl methodDecl, Map<String, String> valueMap) {
        //获取所有
                        ...
                        arguments.forEach(arg -> {
                            if (arg instanceof JCTree.JCLiteral) {
                                ...
                                if (StringUtils.isNotEmpty(value)) {
                                    System.out.println(className + message + value);
                                }
                            }
