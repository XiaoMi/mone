...
//        String script = new String(Files.readAllBytes(Paths.get("/Users/zzy/IdeaProjects/mione/jcommon/antlr/src/main/java/com/xiaomi/data/push/antlr/example/Example.java")));
        String script = new String(Files.readAllBytes(Paths.get("/Users/zhangzhiyong/IdeaProjects/mione/jcommon/antlr/src/main/java/com/xiaomi/data/push/antlr/example/Example.java")));
