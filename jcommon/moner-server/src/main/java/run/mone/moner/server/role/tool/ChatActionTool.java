...
public class ChatActionTool implements ITool {
    ...
    public String description() {
        return """
                ...
                举例：
                - 用户描述：\"我要买一个新的手机\" → 请使用购物相关的工具。
                - 用户描述：\"你好，今天过得怎么样？\" → 使用聊天：
    ...
    public String parameters() {
        return "- message: (required) The chat message to respond to the user. The message should be natural, friendly, and maintain coherence and relevance with the user's input.";
    }
