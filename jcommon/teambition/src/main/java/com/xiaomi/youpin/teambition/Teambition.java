...
public class Teambition {
    ...
    private static final String memberListUrl = "https://tb.mioffice.cn/gateway/project/member/list?projectId=";
    private static final String createProjectUrl = "https://tb.mioffice.cn/api/projects";
    private static final String createTaskUrl = "https://tb.mioffice.cn/gateway/task/create";
    private static final String updateTaskUrl = "https://tb.mioffice.cn/gateway/task/update";
    private static final String qryTaskUrl = "https://tb.mioffice.cn/gateway/task/query";
    private static final String tqlsearchUrl = "https://tb.mioffice.cn/gateway/task/tqlsearch";
    private static final String getIdUrl = "https://tb.mioffice.cn/gateway/user/getId?email=";
    private static final String qryProjectUrl = "https://tb.mioffice.cn/gateway/project/query";
    private static final String batchQryUserUrl = "https://tb.mioffice.cn/gateway/user/batchQuery";
    private static final String taskflowQryUrl = "https://tb.mioffice.cn/gateway/taskflow/query?taskflowId=";
    private static final String templateQryUrl = "https://tb.mioffice.cn/gateway/template/query?projectId=";
    ...
    public boolean createProject () {
        String url = "https://tb.mioffice.cn/api/projects";
        OldProjectInfo projectInfo = new OldProjectInfo();
        projectInfo.set_organizationId("60bf5445e1bf12b29910940f");
        projectInfo.setName("test0822");
        //projectInfo.setType("normal");
        projectInfo.setVisibility("project");
        String response = HttpClientV2.post(url, new Gson().toJson(projectInfo), getHeaders("60bf5445e1bf12b29910940f"), 2000);
        return true;
    }
