...
public class HeraLogCreateTool implements ITool {
    ...
    public String parameters() {
        return """
                ...
                - envId: (必填) miline中的项目的流水线id，数字类型
    ...
    public JsonObject execute(ReactorRole role, JsonObject inputJson) {
        ...
        try {
            ...
            if (!inputJson.has("envId")) {
                log.error("hera_log_create 操作缺少必填参数 envId");
            ...
            Long envId = inputJson.get("envId").getAsLong();
            ...
            log.info("开始创建日志，miline项目id: {}, 流水线id: {}, tail名称: {}， 日志路径: {}", projectId, envId, tailName, logPath);

            // 调用服务查询日志详情
            String logResult = heraLogService.createLogByMiline(projectId, envId, tailName, logPath);
            ...
            log.info("成功创建Hera日志，projectId: {}, envId: {}", projectId, envId);
