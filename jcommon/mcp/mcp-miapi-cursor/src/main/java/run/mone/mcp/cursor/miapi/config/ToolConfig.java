...
import run.mone.mcp.cursor.miapi.function.MiApiTestFunction;
...
//                        new ExecuteCommandTool(),
                ...
                .mcpTools(Lists.newArrayList(new ChatFunction(agentName, 20),new MiApiTestFunction()))
                .meta(ImmutableMap.of(Const.HTTP_PORT,"8083",Const.AGENT_SERVER_NAME,"miapi_server"))
                .build();
    }
}
