...
package run.mone.mcp.docker.server;
...
public class DockerMcpServer {
    ...
    public DockerMcpServer(ServerMcpTransport transport) {
        this.transport = transport;
    }

    public McpSyncServer start() {
        McpSyncServer syncServer = McpServer.using(transport)
                .serverInfo("docker_mcp", "0.0.1")
        ...
        DockerFunction function = new DockerFunction();
