...
@Data
@Slf4j
public class Wait implements McpTool {

    private String name = "wait";
    private String desc = "等待一段时间";
        ...
        try {
            ...
            try (CloseableHttpResponse response = httpClient.execute(request)) {
                ...
                if (response.getStatusLine().getStatusCode() != 200) {
                    throw new IOException("Failed to capture screen after wait: " + EntityUtils.toString(entity));
                }
            ...
            return new McpSchema.CallToolResult(List.of(new McpSchema.TextContent("Error in wait: " + e.getMessage())), true);
        }
    }
}
