...
@Data
@Slf4j
public class MouseLeftClick implements McpTool{
    private String name = "mouse_leftClick";
    private String desc = "模拟鼠标左键点击";
        ...
        try {
            ...
            try (CloseableHttpResponse clickResponse = httpClient.execute(clickRequest)) {
                ...
                if (clickResponse.getStatusLine().getStatusCode() != 200) {
                    throw new IOException("Failed to left click mouse: " + EntityUtils.toString(entity));
                }
