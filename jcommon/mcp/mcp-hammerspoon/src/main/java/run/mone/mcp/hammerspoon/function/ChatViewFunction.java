...
public class ChatViewFunction implements Function<Map<String, Object>, McpSchema.CallToolResult> {
    ...
    private String desc = "在企业微信中搜索指定联系人/群";
    ...
    public McpSchema.CallToolResult apply(Map<String, Object> args) {
        try {
            ...
            Map<String, String> requestBodyMap = Map.of(
                    "contactName", StringUtils.escapeWxUserName(StringUtils.escapeWxUserName(contactName))
            );
            ...
            Request request = new Request.Builder()
                    .url(pythonServerUrl + "/searchWeComContact")
                    .post(body)
                    .build();
