...
@Data
@Slf4j
public class ViewChatContentBelowFunction implements Function<Map<String, Object>, McpSchema.CallToolResult> {
    private String name = "view_chat_content_below";
    private String desc = "聊天记录向下滚动一页";
    ...
    public ViewChatContentBelowFunction() {
    ...
    public McpSchema.CallToolResult apply(Map<String, Object> args) {
        try {
            ...
            Request request = new Request.Builder()
                    .url(pythonServerUrl + "/viewChatContentBelow")
            ...
            try (Response response = client.newCall(request).execute()) {
                ...
                log.info("Response from /viewChatContentBelow: {}", responseBody);

                if (!response.isSuccessful()) {
                     log.error("HTTP Error calling /viewChatContentBelow: {} - {}", response.code(), responseBody);
