 ...
 */
@Slf4j
public class CallHttpInterceptor implements MethodInterceptor {
    ...
    public CallHttpInterceptor(Ioc ioc, Config config, MeshMsService reference) {
        this.ioc = ioc;
        this.config = config;
    ...
    public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
        ...
        log.info("call http receive:{}", res.getData());
