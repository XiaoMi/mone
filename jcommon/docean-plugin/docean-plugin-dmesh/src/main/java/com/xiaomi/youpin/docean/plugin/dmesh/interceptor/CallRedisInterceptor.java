 ...
 */
@Slf4j
public class CallRedisInterceptor implements MethodInterceptor {
    ...
    public CallRedisInterceptor(Ioc ioc, Config config, MeshMsService reference) {
        this.ioc = ioc;
        this.config = config;
    ...
    public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
        ...
        command.setCmd("redis");
        command.setServiceName("redis");
        ...
        log.info("call redis receive:{}", res.getData());
