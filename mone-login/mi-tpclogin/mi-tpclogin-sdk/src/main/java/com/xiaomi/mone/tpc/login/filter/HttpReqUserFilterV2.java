 ...
 * @date: 2022/3/3 15:38
 */
public class HttpReqUserFilterV2 implements Filter {

    private static final Logger log = LoggerFactory.getLogger(HttpReqUserFilterV2.class);
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        if (innerAuth) {
            casFilter = new AuthCasFilterV2();
            casFilter.init(filterConfig);
        } else {
            tokenFilter = new AuthTokenFilterV2();
