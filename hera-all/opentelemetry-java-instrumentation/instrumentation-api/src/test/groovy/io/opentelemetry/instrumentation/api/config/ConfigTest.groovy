...
class ConfigTest extends Specification {
  ...
  def "should get boolean property"() {
    ...
    expect:
    !config.getBoolean("property.bool", true)
    config.getBoolean("does-not-exist", true)
  }
  ...
  def "should get list property"() {
    ...
    expect:
    config.getList("property.list") == ["one", "two", "three"]
    config.getList("property.list", ["four"]) == ["one", "two", "three"]
    config.getList("does-not-exist") == []
    config.getList("does-not-exist", ["four"]) == ["four"]
  }
