...
public class MilogLogTailDao {
    ...
    public boolean updateMilogLogtail(Long id, Integer parseType, String parseScript, String logPath, String valueList, Long appId, Long envId, String envName,
                                      ...
                                      Long milogAppId, String appName, String logSplitExpress, Integer deployWay) {
//        int ret = dao.update(MilogLogTailDo.class, Chain.make("space_id", spaceId).add("app_id", appId).add("parse_type",parseType).add("log_path",logPath).add("value_list",valueList), Cnd.where("id", "=", id));
    ...
    public List<MilogLogTailDo> queryByAppId(Long milogAppId) {
    ...
    public List<MilogLogTailDo> queryByMilogAppAndEnvK8s(Long milogAppId, Long envId, Integer appTypeCode) {
        return dao.query(MilogLogTailDo.class,
                Cnd.where("milog_app_id", EQUAL_OPERATE, milogAppId)
                        .and("env_id", EQUAL_OPERATE, envId)
//                        .and("app_type", EQUAL_OPERATE, appTypeCode)
                        .and("deploy_way", EQUAL_OPERATE, DeployWayEnum.MIONE.getCode()));
    }
    ...
    public List<MilogLogTailDo> queryMisTail() {
//        return dao.query(MilogLogTailDo.class, Cnd.where("app_type", EQUAL_OPERATE, ProjectTypeEnum.MIS_TYPE.getCode()));
        return Lists.newArrayList();
    }
    ...
    public List<MilogLogTailDo> queryMisTailByAppId(Long serviceId) {
//        return dao.query(MilogLogTailDo.class, Cnd.where("app_id", EQUAL_OPERATE, serviceId).and("app_type", EQUAL_OPERATE, ProjectTypeEnum.MIS_TYPE.getCode()));
        return Lists.newArrayList();
    }
...
//                .and("store_id", EQUAL_OPERATE, storeId)
    ...
    public List<MilogLogTailDo> queryTailsByAppAndStores(Long milogAppId, List<Long> storeIds) {
        return dao.query(MilogLogTailDo.class, Cnd.where("milog_app_id", EQUAL_OPERATE, milogAppId)
