...
public class AppServiceMarket {
    ...
    public void setBelongTeam(String belongTeam) {
        this.belongTeam = belongTeam == null ? null : belongTeam.trim();
    }
    ...
    public enum Column {
        ...
        belongTeam("belong_team", "belongTeam", "VARCHAR", false),
        creator("creator", "creator", "VARCHAR", false),
        serviceList("service_list", "serviceList", "VARCHAR", false),
        lastUpdater("last_updater", "lastUpdater", "VARCHAR", false),
