...
public enum ReqErrorMetrics {
    ...
    oracleException("oracleError","oracle请求错误",AlarmPresetMetrics.oracle_error_times, AlarmPresetMetrics.oracle_availability),
    esException("elasticsearchClientError","es请求错误",AlarmPresetMetrics.es_error_times, AlarmPresetMetrics.es_availability),
