...
public enum PlatFormType {
    ...
    informationDept(1,"informationDept","china",PlatForm.mit,"信息部",1),
    youpin(2,"youpin","youpin", PlatForm.mione,"有品",0),
    deployment(6,"deployment","cloud", PlatForm.miCloud,"云平台(deployment)",6),
    mice(7,"mice","cloud", PlatForm.miCloud,"云平台(mice)",7),
    matrix(8,"matrix","cloud", PlatForm.miCloud,"云平台(matrix)",8),
    ocean(9,"ocean","cloud", PlatForm.miCloud,"云平台(ocean)",9),
    neo(10,"neo","cloud", PlatForm.miCloud,"云平台(neo)",10),
    ;
