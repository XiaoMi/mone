...
public enum AlarmPresetMetrics {
    ...
    http_client_slow_query("http_client_slow_query","Http调入慢查询", MetricsUnit.UNIT_COUNT, SendAlertGroupKey.APP_METHOD, AlarmStrategyType.INTERFACE,InterfaceMetricTypes.slow_times),
