...
public class EnvOrJvmProperties {
  ...
  public static final HeraJavaagentConfig JVM_OTEL_RESOURCE_ATTRIBUTES = new HeraJavaagentConfig("otel.resource.attributes", HeraJavaagentConfigType.JVM, "service.name=none");
  ...
  public static final HeraJavaagentConfig JVM_OTEL_NACOS_ADDRESS = new HeraJavaagentConfig("otel.exporter.prometheus.nacos.addr", HeraJavaagentConfigType.JVM);
  ...
  public static final HeraJavaagentConfig ENV_SERVER_ENV = new HeraJavaagentConfig("serverEnv", HeraJavaagentConfigType.ENV);

  public static final List<HeraJavaagentConfig> INIT_ENV_JVM_LIST = new ArrayList<>();

  static {
    INIT_ENV_JVM_LIST.add(JVM_OTEL_RESOURCE_ATTRIBUTES);
