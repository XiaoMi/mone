...
final class SdkSpanBuilder implements SpanBuilder {
  ...
  public Span startSpan() {
    ...
    String traceId;
    Map<String,String> heraContext = HeraContext.isValid(parentSpanContext.getHeraContext()) ? parentSpanContext.getHeraContext() : HeraContext.getInvalid();
    ...
    SpanContext spanContext =
        SpanContext.create(
            ...
            samplingResultTraceState, heraContext);
