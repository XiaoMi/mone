 ...
 * #create(String, String, TraceFlags, TraceState, Map)} or {@link #createFromRemoteParent(String,
 * String, TraceFlags, TraceState, Map)}.
 */
public interface SpanContext {
  ...
  static SpanContext getInValidWithHeraContxt(Map<String,String> heraContext) {
    return ImmutableSpanContext.createInvalidWithHeraContext(heraContext);
  }
  ...
  static SpanContext create(
      String traceIdHex, String spanIdHex, TraceFlags traceFlags, TraceState traceState, Map<String,String> heraContext) {
    return ImmutableSpanContext.create(
        traceIdHex, spanIdHex, traceFlags, traceState, /* remote=*/ false, heraContext);
  }
  ...
  static SpanContext createFromRemoteParent(
      String traceIdHex, String spanIdHex, TraceFlags traceFlags, TraceState traceState, Map<String,String> heraContext) {
    return ImmutableSpanContext.create(
        traceIdHex, spanIdHex, traceFlags, traceState, /* remote=*/ true, heraContext);
  }
  ...
  Map<String,String> getHeraContext();
}
