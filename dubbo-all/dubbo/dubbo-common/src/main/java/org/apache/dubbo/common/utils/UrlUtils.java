...
public class UrlUtils {
    ...
    public static boolean isMatch(URL consumerUrl, URL providerUrl) {
        ...
        String providerGroup = providerUrl.getParameter(GROUP_KEY) == null ? providerUrl.getParameter(Constants.DEFAULT_KEY_PREFIX + GROUP_KEY) : providerUrl.getParameter(GROUP_KEY);
        String providerVersion = providerUrl.getParameter(VERSION_KEY) == null ? providerUrl.getParameter(Constants.DEFAULT_KEY_PREFIX + VERSION_KEY) : providerUrl.getParameter(VERSION_KEY);
