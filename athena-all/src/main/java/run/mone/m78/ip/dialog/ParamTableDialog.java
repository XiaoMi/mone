...
import run.mone.m78.ip.bo.prompt.PromptParamType;
import run.mone.m78.ip.bo.ParamDialogReq;
import run.mone.m78.ip.bo.PromptInfo;
import run.mone.m78.ip.bo.prompt.PromptParam;
...
public class ParamTableDialog extends DialogWrapper {
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        panel.setPreferredSize(ScreenSizeUtils.size());
        panel.setMinimumSize(ScreenSizeUtils.size());
        return panel;
    }
