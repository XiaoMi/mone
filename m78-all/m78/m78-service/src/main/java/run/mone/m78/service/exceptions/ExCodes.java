...
public class ExCodes {
    ...
    public static final ErrorCode STATUS_TIME_OUT = ErrorCode.createOnce(DEFAULT_ERROR_SCOPE, 408);
    ...
    public static final ErrorCode STATUS_INVALID_ARGUMENT = ErrorCode.createOnce(DEFAULT_ERROR_SCOPE, 410);

    public static final ErrorCode STATUS_ASR_ESTABLISH_FAILED = ErrorCode.createOnce(DEFAULT_ERROR_SCOPE, 700);

    public static final ErrorCode STATUS_ASR_RECOGNIZED_ERROR = ErrorCode.createOnce(DEFAULT_ERROR_SCOPE, 701);
