 ...
 * @LastEditTime: 2024-03-19 20:44:13
-->
<template>
  <div class="probot-flow-form">
    <div class="flow-plug">
      <BaseGroup
        ...
        title="任务"
        tooltip="暂定"
        :btn="{ name: '创建', icon: 'icon-plus1', click: addPlug, size: 'small' }"
      ></BaseGroup>
...
import TaskTypeSel from '../components/TaskTypeSel.vue'
import IntervalCom from '../components/IntervalCom'
