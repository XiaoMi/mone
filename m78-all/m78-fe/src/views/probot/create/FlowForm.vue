 ...
 * @LastEditTime: 2024-03-19 20:47:29
-->
<template>
      ...
      <template v-slot:right="{ item, index }">
        <div v-for="(v, i) in item.plugins" :key="i" class="child-container">
          ...
          <div class="btn-container">
            ...
            <BaseLink name="移除" icon="icon-yichu" @click="removePlug(index, i)"></BaseLink>
          </div>
        </div>
      </template>
    </BindLayout>
    ...
    >
      <template v-slot:right="{ item, index }">
        <div class="btn-container">
          ...
          ></BaseLink>
          <BaseLink name="卡片样式" icon="icon-danlanqiapianyangshi"></BaseLink>
          <BaseLink name="移除" icon="icon-yichu" @click="removeWorkflow(index)"></BaseLink>
        </div>
      </template>
    </BindLayout>
...
import BindLayout from './BindLayout.vue'
