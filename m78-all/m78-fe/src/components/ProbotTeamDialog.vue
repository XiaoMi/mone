<template>
  ...
  >
    <div class="create-team-dialog-container">
      <div class="title">
        <h3>通过创建一个团队，支持Probot、插件、工作流、知识库的协作与共享。</h3>
      </div>
...
const rules = reactive<FormRules<RuleForm>>({
  ...
  desc: [{ required: true, message: '请输入团队描述', trigger: 'blur' }],
  avatarUrl: [{ required: true, message: '请上传或生成团队图标', trigger: 'change' }]
})
