    ...
    <el-dialog
      ...
      <el-form
        ...
        <el-form-item
          ...
          prop="gitAddress"
        >
            <el-input disabled :value="`https://git.n.xiaomi.com/${form.gitGroup}/${form.gitName}`" />
        </el-form-item>
        <el-form-item
          label="描述"
          prop="desc"
        ...
        data => {
          if (data) {
            ...
            for (const item of data) {
              if (item.roleType == 0) {
                owners.push(item.accountId)
              } else if (item.roleType == 1) {
                members.push(item.accountId)
              }
            }
            this.mForm.members = members
            this.mForm.owners = owners
