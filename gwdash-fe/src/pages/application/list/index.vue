    ...
    <div class="wrapper-bottom">
      <div class="clearfix" id='content-left'>
                ...
                <div>
                  ...
                  <span class="project-icon">
                    <el-link
                      ...
                      :underline="false"
                      title="编辑">
                          <img src="https://img.youpin.mi-img.com/middlewareGroup/3ff8fefee13bf74aba3133cf0463af3c.png?w=80&h=46" class='project-icon-item' alt="">
                      </el-link>
                    <el-link
                      ...
                      :underline="false"
                      title="代码生成">
                          <img src="https://img.youpin.mi-img.com/middlewareGroup/c29789bb4050a26f875a589f182ba0f3.png?w=80&h=46" class='project-icon-item' alt="">
                      </el-link>
                    <el-link
                      @click="goApiInfo(projectForm.id)"
                      :underline="false"
                      title="新建API">
                          <img src="https://img.youpin.mi-img.com/middlewareGroup/8f50b4c7a0056f40c0be0d47bcf081e6.png?w=80&h=46" class='project-icon-item' alt="">
                      </el-link>
                    <el-link
                      ...
                      style="margin-left:6px">
                          <img src="https://img.youpin.mi-img.com/middlewareGroup/e704eb275a09acd224a3b66aa878351f.png?w=80&h=46" class='project-icon-item' alt="">
                      </el-link>
                      <el-link
                        v-if="isSuperRole"
        ...
        <d2-module id="dm3" >
              <el-tabs v-model="activeName" @tab-click="handleTabClick">
                <el-tab-pane label="环境配置" name="env">
                  <div class="container-left_all"
                      v-if="projectForm.type === 'spring' || projectForm.type === 'other'"
                    >
              ...
              <div v-if='projectListOptions.length == 0'>
    ...
    >
      <el-form :model="form" ref="form" label-width="112px" :rules="createProRules" size="mini">
        ...
        <el-form-item label="git地址" class='gitaddress'>
          <el-input value="https://git.n.xiaomi.com/" placeholder disabled style="width:25%"></el-input>
        ...
        <div
          v-else-if="projectAction == 'gen' && form.projectGen.type == 'filter'"
        >
        ...
        <div
          v-else-if="projectAction == 'gen' && form.projectGen.type == 'plugin'"
        >
