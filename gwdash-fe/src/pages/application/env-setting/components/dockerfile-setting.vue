  ...
  <div>
     ...
     <el-card style="margin-bottom:20px">
      <el-form :model="form" :rules="rulesTop" size="mini" label-width="110px" ref='formTop'>
         <el-form-item label="cpu" prop="cpu">
          <el-input-number v-model="form.cpu" controls-position="right" placeholder="cpu个数" style="width: 15%" :min="1" :max="16"></el-input-number>
       </el-form-item>
       <el-form-item label="内存(M)" prop="memory">
          <el-input-number v-model="form.memory" controls-position="right" placeholder="内存大小" style="width: 15%" :min="2048" :max="49125"></el-input-number>
       </el-form-item>
    ...
    <el-card>
      <el-form :model="form" :rules="rulesBottom" size="mini" label-width="110px" ref='formBottom'>
       ...
       <el-form-item label="dockerfile目录" prop="dockerfilePath">
        <el-input v-model="form.dockerfilePath" placeholder="Dockerfile所在目录，不填默认根目录" style="width: 50%"></el-input>
       </el-form-item>
          ...
          <span slot="label">
            ...
            >
              <div style="text-align:center;">
                <a
                  style="color: #409EFF;"
                  href="https://wiki.n.miui.com/pages/viewpage.action?pageId=364779454"
                  type="primary"
                  target="_blank"
          ...
          labels
            <el-popover
              ...
              <div style="fontSize:12px">
                支持标签说明：<br>
                  &nbsp 暴露端口相关标签，支持暴露3个端口：<br>
                  &nbsp &nbsp http_port=端口号<br>
                  &nbsp &nbsp dubbo_port=端口号<br>
                  &nbsp &nbsp third_port=端口号<br>
                &nbsp 注：端口号为应用中指定的端口，若为-1时不指定<br>
                
                &nbsp 需要keycenter：<br>
                  &nbsp &nbsp keycenter=true
              </div>
              <i slot="reference" class="el-icon-question"></i>
            </el-popover>
          </span>
        <el-input v-model="form.labels" placeholder="必填, 长度0-200" style="width: 50%"></el-input>
       </el-form-item>
        <el-form-item>
...
export default {
  ...
  data () {
    var checkLogPath = (rule,value,callback) => {
      ...
      } else if (!(value.startsWith("xxxx/log/")) || !(value.endsWith("/"))) {
         callback(new Error('路径必须以 xxxx/log/ 开头、以 / 结尾'))
