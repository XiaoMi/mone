...
<template>
  <d2-container>
    ...
    <el-dialog title="添加plugin" :visible.sync="addPluginDialogVisible" width="800px">
      <el-form :model="formAdd" label-width="110px" ref="uploadForm" :rules="rules" size="mini">
        ...
        <el-form-item label="git地址" class='gitaddress'>
          <el-input value="https://git.n.xiaomi.com/" placeholder disabled style="width:30%"></el-input>
          <div style="display:inline-block; width:25%">
            <el-form-item prop="group">
              <el-input v-model="formAdd.group" placeholder="请输入组名"></el-input>
            </el-form-item>
          </div>
          <el-input value="/" placeholder disabled style="width:6%"></el-input>
          <div style="display:inline-block; width:25%">
        ...
        <el-form-item label="commit" prop="commitId">
          ...
          <span v-if="commitLoading" @click="getCommitList">
            <i class="el-icon-refresh" style="font-size:19px; margin-left: 6px"></i>
          </span>
          <span v-else>
    ...
    <el-dialog title="编辑plugin" :visible.sync="editPluginDialogVisible" width="800px">
      <el-form
        :model="formEdit"
        label-width="110px"
        ref="uploadEditForm"
      ...
      >
        ...
        <el-form-item label="git地址" class='gitaddress'>
          <el-input value="https://git.n.xiaomi.com/" placeholder disabled style="width: 38%"></el-input>
          <div style="display:inline-block; width:25%">
            <el-form-item>
              <el-input v-model="formEdit.group" placeholder="请输入组名" disabled></el-input>
            </el-form-item>
          </div>
          <el-input value="/" placeholder disabled style="width: 8%"></el-input>
          <div style="display:inline-block; width:25%">
            <el-form-item>
              <el-input v-model="formEdit.name" placeholder="请输入项目名" disabled></el-input>
            </el-form-item>
          </div>
        </el-form-item>
    ...
    <el-dialog title="切换plugin版本" :visible.sync="versionPluginDialogVisible" width="30%">
    ...
    <el-dialog title="选择 group" :visible.sync="selectPluginGroupDialogVisible" width="30%">
      <el-form :inline="true" :model="formEdit">
    ...
    <el-dialog title="DEBUG" :visible.sync="debugDialogVisible" width="30%">
    ...
    <el-dialog title="归还权限" :visible.sync="authorityFormVisible">
  ...
  methods: {
    ...
    getCommitList() {
      ...
      if (this.formAdd.group && this.formAdd.name) {
        service({
          url: `/plugin/commits?group=${this.formAdd.group}&name=${this.formAdd.name}`,
          method: "GET"
        })
          .then(res => {
            res.forEach(item => {
    ...
    // 编辑
    handleUpdate(row) {
      this.formEdit = { ...row, name: row.gitName, group: row.gitGroup };
    ...
    submitChangeVersion() {
      const version = this.selectPlugin.split("|")[0];
      const dataId = this.selectPlugin.split("|")[1];
