    ...
    <el-dialog :title='formTitle' :visible.sync='formVisible' width='800px' class='mirror-dialog'> 
      <el-form :model='form' :rules='rules' ref='form' size='mini' label-width="120px">
          <el-form-item label="git地址" class='gitaddress'>
            <el-input value="https://git.n.xiaomi.com/" disabled style="width:30%"></el-input>
  ...
  methods: {
    ...
    submitFormUpload(formName) {
      this.$refs[formName].validate(valid => {
        ...
        service({
          ...
          method: 'POST',
          data: qs.stringify({
            gitAddress: `https://git.n.xiaomi.com/${form.groupName}/${form.projectName}`,
            ...form
          })
        }).then(res => {
    ...
    getCommitList() {
      ...
      if(form.groupName && form.projectName) {
        ...
        var gitAddress = `https://git.n.xiaomi.com/${form.groupName}/${form.projectName}`;
        service({
