...
<template>
  <div class="each-video">
    <video :ref="newVideoContent.ctime"
           ...
           poster="https://img.youpin.mi-img.com/comment/b774bcbff14adcbfa63b1e922ae6b8f1.png@base@tag=imgScale&m=0&w=266&h=180&c=1"
...
.each-video{
  ...
  .btn {
      width: 62px;
      height: 62px;
      background-image: url(https://img.youpin.mi-img.com/middlewareGroup/d7c63b6275da99e94a8cae939ba48cf9.png?w=186&h=186);
  ...
  .btn-pause {
    background-image: url(https://img.youpin.mi-img.com/middlewareGroup/5cf5deb6faa3c9a0c1f158cb910d5d2b.png?w=186&h=186);
  }
}
