...
.logo-group{
  ...
  .logo {
    ...
    height: 58px;
    cursor: pointer;
    background-image: url(https://img.youpin.mi-img.com/middlewareGroup/bc2760095ced4836118ea82aadb91332.png?w=375&h=174);
    background-size: 100% 100%;

    // background-image: url(https://img.youpin.mi-img.com/ArchitectureGroup/edb6235598f19a4f28e0376da25fd403.png?w=261&h=200);
