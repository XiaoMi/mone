...
import { AccountLogout } from '@/api/sys/logout'

const casUrl = process.env.VUE_APP_CAS_URL

const casLogoutUrl = casUrl + `logout?service=${encodeURIComponent(`${casUrl}/login?service=${encodeURIComponent(window.location.href)}`)}`
