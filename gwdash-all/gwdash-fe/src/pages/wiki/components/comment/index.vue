...
<template>
  <el-form
    ...
    <el-form-item
      ...
      label="任务状态"
    >
      <el-select v-model="form.status" style="width:35%" filterable default-first-option>
        <el-option
    ...
    <el-form-item v-if="showProject" prop="projectId" label="项目选择">
      <el-select
    ...
    <el-form-item prop="content" :label="showTitle ? '任务详情' : '解决方案'" style="margin-bottom:0px">
      <d2-mde v-model="form.content" placeholder="markdown描述" class="mde" v-if="reFresh"/>
    </el-form-item>
    <el-form-item style="text-align:right">
      <el-button type="primary" size="mini" @click="submit('ruleForm')">提交</el-button>
    </el-form-item>
  </el-form>
</template>
<script>
