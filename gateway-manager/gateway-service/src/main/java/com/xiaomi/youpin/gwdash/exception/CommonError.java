...
public enum CommonError {
    ...
    MachinePowerOffError(300000, "机器已经关掉"),
    InvalidGitToken(301000, "git token 无效或已过期"),
    NotFoundGitProject(301001, "无该项目git权限或git项目不存在"),
    HeathCheckParamError(301002, "该环境配置的健康检查参数有误，请修改后重新部署，确认继续发布，请再次点击部署成功！"),
    HeathCheckFail(301003, "健康检查未发现运行的服务，请查确认实际是否部署成功，确认继续发布，请再次点击部署成功！"),
    ;
