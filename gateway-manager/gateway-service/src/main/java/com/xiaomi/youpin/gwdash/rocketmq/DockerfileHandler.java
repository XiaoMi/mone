...
//
//    public static final String DOCKER_BUILD_INFO = "docker-build-status";
//
...
//        String pushMsgId = dockerResData.getPushMsgId();
//        if (StringUtils.isNotEmpty(pushMsgId)) {
//            CiCdWebSocketHandler.pushMsg(pushMsgId, new Gson().toJson(message));
//            message.setMsgType(DOCKER_BUILD_LOGS);
//            CiCdWebSocketHandler.pushMsg(pushMsgId, new Gson().toJson(message));
//        }
//        logService.saveLog(LogService.ProjectDockerBuild, id, dockerResData.getMessage());
//    }
//}
