...
//    public static final String ProjectWebBuild = "ProjectWebBuild";
...
//    }
//
//    public String listFile(String ip, String path) {
//        LogReq logReq = new LogReq();
//        logReq.setCmd("list");
//        logReq.setPath(path);
//        String address = agentManager.getClientAddress(ip);
//        if (address != null) {
//            RemotingCommandBo res = agentManager.send(address, AgentCmd.logReq, new Gson().toJson(logReq), 35000);
//            if (null != res) {
...
//    }
//
//    public String showFile(String ip, String path, String grepRegex, long pointer, int lineNum) {
//        LogReq logReq = new LogReq();
//        logReq.setCmd("log");
//        logReq.setPath(path);
//        logReq.setGrepRegex(grepRegex);
//        logReq.setPointer(pointer);
//        logReq.setLineNum(lineNum);
//        String address = agentManager.getClientAddress(ip);
//        if (address != null) {
//            RemotingCommandBo res = agentManager.send(address, AgentCmd.logReq, new Gson().toJson(logReq), 35000);
//            if (null != res) {
...
//    }
//
//    public Result<Map<String, Object>> envInfo(long envId) {
//        ProjectEnv projectEnv = projectEnvService.getProjectEnvById(envId).getData();
//        Map<String, Object> res = Maps.newHashMap();
//        res.put("logPath", "/home/work/log/");
//        // res.put("machines", Lists.newArrayList());
//        if (null != projectEnv) {
//            ProjectPipeline pipeline = pipelineService.getProjectPipelineById(projectEnv.getPipelineId()).getData();
//            if (null != pipeline) {
//                DeploySetting deploySetting = pipeline.getDeploySetting();
//                if (null != deploySetting) {
//                    res.put("logPath", deploySetting.getDockerLogPath());
//                    // res.put("machines", pipeline.getDeployInfo().getDockerMachineList());
//                }
//            }
//        }
