...
//
//    @Autowired
//    private DockerExecWebSocketHandler dockerExecWebSocketHandler;
//
//    @Autowired
...
//                .addInterceptors(new WebSocketHandshakeInterceptor(aegisSdk))
//                .setAllowedOrigins("*")
//                .withSockJS()
...
//        // docker exec
//        webSocketHandlerRegistry
//                .addHandler(dockerExecWebSocketHandler, "/ws/docker/ssh")
//                .addInterceptors(new WebSocketHandshakeInterceptor(aegisSdk))
//                .setAllowedOrigins("*")
//                .withSockJS()
//                .setClientLibraryUrl(socketjsLibUrl);
...
//        return new WebSocketHandshakeInterceptor(aegisSdk);
//    }
//}
