...
//    }
//
//    @RequestMapping(value = "/billing/detail/topten", method = {RequestMethod.POST, RequestMethod.GET})
//    public Result<Map<Object, String>> topten() {
//        return billingService.topten();
//    }
//
////    @RequestMapping(value = "/billing/detail/test", method = {RequestMethod.POST, RequestMethod.GET})
////    public void test() {
////        billingService.billingTopTenTask();
//    //
////    }
//
//    @RequestMapping(value = "/billing/detail/open", method = {RequestMethod.POST, RequestMethod.GET})
//    public Result<Boolean> open() {
//        billingService.open();
//        return Result.success(true);
//    }
//
//    @RequestMapping(value = "/billing/top/projectId", method = {RequestMethod.POST, RequestMethod.GET})
//    public Result<Map<Object, String>> topProjectId(Long projectId, Integer year) {
//        log.info("BillingController /billing/top/projectId projectId:{}, year:{}", projectId, year);
//        return billingService.topProjectId(projectId, year);
//    }
//
//    @RequestMapping(value = "/billing/top/time", method = {RequestMethod.POST, RequestMethod.GET})
//    public Result<Map<Object, String>> topTime(Integer year, Integer month) {
//        log.info("BillingController /billing/top/time projectId:{}, month:{}", year, month);
//        return billingService.topTime(year, month);
//    }
//
//}