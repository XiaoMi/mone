...
//     * @return
//     */
//    @RequestMapping(value = "/api/machine/release", method = RequestMethod.POST)
//    public Result<List<String>> releaseResource(@RequestBody ReleaseBo bo) {
//        log.info("releaseResource:{}", bo);
//        List<String> list = projectDeploymentService.releaseResource(bo.getIp(), bo.getNum(), bo.isNuke()).stream().collect(Collectors.toList());
...
//     * @return
//     */
//    @RequestMapping(value = "/api/machine/removeresource", method = RequestMethod.POST)
//    public Result<Boolean> removeResource(@RequestBody RemoveBo bo) {
//        log.info("remove resource:{}", bo);
//        return Result.success(projectDeploymentService.removeResource(bo.getIp()));
//    }
//
//
