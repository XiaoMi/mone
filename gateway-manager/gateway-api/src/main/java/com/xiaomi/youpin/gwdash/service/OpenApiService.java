...
//
//    /**
//     * docker 扩容一个docker container
//     */
//    Result<Boolean> scaleUpByOne(DockerOptRequest request);
//
//
//    /**
//     * docker 机器打标签
...
//
//    Result<Boolean> startPowerOnTask(String ip);
//
//    Result<Boolean> startPowerOnTask(String ip, long projectId, long envId);
//
//    Result<Boolean> powerOff(String ip);
//
//    void updateHealthResult(long envId, String healthResult);
//
//    /**
//     *
//     * @param ip
//     * @return
//     */
//    List<Long> getAppIdListByIp(String ip);
//
//}
