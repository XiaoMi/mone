...
public interface RecordingDubboService {
    ...
    Result<RecordingConfig> recordingConfigDetail(RecordingConfigReq req);

    Result<List<CommonEnum>> getGatewayEnvTypes(String env);

    Result<List<CommonEnum>> getRecordingStrategys();
