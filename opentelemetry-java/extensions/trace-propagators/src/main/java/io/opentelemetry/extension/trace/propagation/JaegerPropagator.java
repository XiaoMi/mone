...
public final class JaegerPropagator implements TextMapPropagator {
  ...
  private static <C> SpanContext getSpanContextFromHeader(
    ...
    return buildSpanContext(traceId, spanId, flags, heraContext);
  }
  ...
  private static SpanContext buildSpanContext(String traceId, String spanId, String flags, String heraContext) {
    try {
      ...
      return SpanContext.createFromRemoteParent(
          ...
          TraceState.getDefault(), HeraContext.wrap(heraContext));
