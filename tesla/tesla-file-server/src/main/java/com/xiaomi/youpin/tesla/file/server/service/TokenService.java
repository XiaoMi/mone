...
//            return generateToken(str).equals(token);
    ...
    public String generateToken(String str) {
        try {
            return Aes.encrypt(str, Config.ins().get("token_key", ""), Config.ins().get("token_iv_param", ""));
        } catch (Exception e) {
    ...
    public String decryptToken(String token) {
        return Aes.decrypt(token, Config.ins().get("token_key", ""), Config.ins().get("token_iv_param", ""));
    }
