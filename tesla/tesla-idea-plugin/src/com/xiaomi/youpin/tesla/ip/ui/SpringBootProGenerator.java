...
import com.xiaomi.youpin.tesla.ip.common.ColorEggUtils;
...
public class SpringBootProGenerator extends JDialog {
    ...
    private void colorEgg(String projectPath, String projectName, String testPath, String packagePath) {
        ...
        FileGenerator mdGenerator = new FileGenerator(projectPath, projectName, projectName + "-api" +
                File.separator + testPath + File.separator + packagePath + File.separator + "test" + File.separator + ".des", "springboot_color_egg.tml");
        Map<String, Object> smpom = new HashMap<>();
        smpom.put("data", str);
