 ...
 */
public class OpenTextAction extends AnAction {


    private static final Logger LOG = Logger.getInstance(OpenTextAction.class);

    private final Notification notification;

    public OpenTextAction(String text, Notification notification) {
        super(text);
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        DataManager.getInstance().getDataContextFromFocus()
                .doWhenDone((Consumer<DataContext>) (dataContext ->
                        new OpenImageConsumer().accept(dataContext)))
