...
public class DubboClient extends IRpcClient implements Dubbo {
    ...
    public FullHttpResponse call(FilterContext ctx, final ApiInfo apiInfo, final FullHttpRequest request) {
        ...
        try {
            ...
            ctx.addTraceEvent("dubbo_call_event", () -> Attributes.builder()
            ...
            log.warn("dubbo invoke param:" + param + "error:" + e.getMessage() + " " + apiInfo.getId() + " " + source + ":" + apiInfo.getUrl() + ", GenericException:{}", e.getMessage());
            ...
            log.warn("dubbo invoke param:" + param + "error:" + e.getMessage() + " " + apiInfo.getId() + " " + source + ":" + apiInfo.getUrl() + ", Throwable:{}", e.getMessage());
