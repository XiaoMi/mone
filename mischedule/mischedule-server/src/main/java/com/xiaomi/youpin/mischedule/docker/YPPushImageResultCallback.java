...
public class YPPushImageResultCallback extends PushImageResultCallback {
    ...
    public YPPushImageResultCallback (TaskContext taskContext, String mqTag, Stopwatch sw, DockerResData dockerResData) {
    ...
    public  void onNext(PushResponseItem item) {
        super.onNext(item);
        dockerResData.setMsg(item.getStatus());
