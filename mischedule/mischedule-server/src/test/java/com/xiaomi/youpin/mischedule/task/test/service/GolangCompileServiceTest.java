...
public class GolangCompileServiceTest extends BaseTest {
    ...
    public void testCompile() {
        ...
        request.setGitUrl("https://git.n.xiaomi.com/youpin-server/zzytest.git");
        request.setBranch("d988e0705b4c558965be83103603e819853f73af");
        request.setProfile("staging");
        request.setTags("Compile");
        request.setGitName("liuyuchong");
        request.setGitToken("MtBC9VF__wFxMxmWPsdX");
        request.setJarPath("zzytest-server");
