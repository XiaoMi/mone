...
import com.xiaomi.data.push.schedule.task.impl.script.ScriptTask;
...
public class ScriptTaskTest {
    ...
    public void testTask() {
        ...
        taskParam.put("script", "def concat(a,b){a+b}");
        taskParam.put("function", "concat");
        taskParam.put("params", "a,b");
        TaskContext context = new TaskContext();
        TaskResult res = scriptTask.execute(taskParam, context);
