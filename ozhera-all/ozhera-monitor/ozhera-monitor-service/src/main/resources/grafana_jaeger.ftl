...
"datasource":"${dataSource}",
"definition": "query_result(count(jvm_classes_loaded_classes{application=\"$application\",serverEnv=~\"$serverEnv\"}))",
"description": null,
"error": null,
"hide": 2,
"includeAll": false,
...
"options": [],
"query": {
"query": "query_result(count(jvm_classes_loaded_classes{application=\"$application\",serverEnv=~\"$serverEnv\"}))",
"refId": "StandardVariableQuery"
},
"refresh": 2,
"regex": "/{} (.*) .*/",
