              ...
              TestSpanData.builder()
                  .setSpanContext(
                      SpanContext.create(
                          ...
                          extractTraceState(span.getTraceState()), HeraContext.getDefault()))
                  ...
                  .setParentSpanContext(
                      SpanContext.create(
                          ...
                          TraceFlags.getDefault(),
                          TraceState.getDefault(), HeraContext.getDefault()))
                  .setResource(
                              ...
                              link ->
                                  LinkData.create(
                                      SpanContext.create(
                                          ...
                                          TraceFlags.getDefault(),
                                          extractTraceState(link.getTraceState()), HeraContext.getDefault()),
