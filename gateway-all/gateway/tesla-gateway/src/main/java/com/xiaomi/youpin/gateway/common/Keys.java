...
public abstract class Keys {
    ...
    /**
     * 最后和gateway-mananger要使用一份
     *
     * @param tenant
     * @return
     */
    public static final String systemFilterSetKey(String tenant) {
        return "gw:system_filter_set_" + tenant;
    }
     ...
     * @return
     */
    public static final String systemFilterKey(String name, String tenant) {
        return "gw:system_filter_" + name + "_" + tenant;
    }
