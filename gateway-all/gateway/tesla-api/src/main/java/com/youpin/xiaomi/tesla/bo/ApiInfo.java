...
public class ApiInfo implements Serializable {
    ...
    private final Map<String, String> domainRefer;
    ...
    public ApiInfo(Long id, Date updateTime, ModifyType modifyType, String url, String path, String application, int flag, Integer routeType, DubboApiInfo dubboApiInfo, ResponseConfig responseConfig, GroupConfig groupConfig, Map<String, FilterInfo> filterInfoMap, PlugInfo plugInfo, int timeout, ScriptInfo scriptInfo, int invokeLimit, int rateInvokeLimit, String httpMethod, String token, String dsIds, int ipAntiBrushLimit, int uidAntiBrushLimit, String filterParams, long cacheTime, List<String> domains, Map<String, String> domainRefer) {
        this.id = id;
        this.updateTime = updateTime;
