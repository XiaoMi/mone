...
public interface TeslaGatewayService {
    ...
    Result<Boolean> updateFilter(FilterParam param);
     ...
     * @return
     */
    Result<Boolean> updateScript(Long id);


    /**
     * 发布 server less 的jar 包
     * @param key
     * @param jarUrl
     * @return
     */
    Result<Boolean> deployServerLessJar(String key, String jarUrl);
