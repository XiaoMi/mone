 ...
 * @author dingpei
 */
public enum RecordingStrategyEnum  implements Serializable {
    ...
    public static final int RESCODE_CODE = 5;

    public static final List<Integer> RECODRING_STRATEGY_CODES = Arrays.asList(PERCENTAGE_CODE, UID_CODE, HEADER_CODE, PARAM_CODE, RESCODE_CODE);
