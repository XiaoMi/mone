...
<template>
  <d2-container>
    <template>
      ...
      <el-dialog title="审核详情" :visible="dialogVisible" @close="cancelDialog" width="800px" :close-on-click-modal=false>
      ...
      <el-dialog title='构建日志' :visible.sync='dialogBuildLogVisible' width='800px' :before-close="dislogClose" :close-on-click-modal=false>
