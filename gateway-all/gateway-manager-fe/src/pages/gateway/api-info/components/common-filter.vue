  ...
  <div>
    ...
    >
      <span slot-scope="{ option }">
        <el-tooltip class="item" effect="dark" placement="top" :content="option.label">
...
export default {
  ...
  data () {
    return {
      data: [],
      form: {},
      filterMethod (query, item) { // transfer筛选方法
  ...
  methods: {
    ...
    onInputFormItem (value) {
      console.log(value)
      const selectedList = this.selectedList
      this.onInput(selectedList)
    },
    onInput (value) {
