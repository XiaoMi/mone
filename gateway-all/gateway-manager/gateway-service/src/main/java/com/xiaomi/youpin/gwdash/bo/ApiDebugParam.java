...
public class ApiDebugParam {
    ...
    public String getGatewaySvrUrl() {
        return gatewaySvrUrl;
    }

    public void setGatewaySvrUrl(String gatewaySvrUrl) {
        this.gatewaySvrUrl = gatewaySvrUrl;
    }
