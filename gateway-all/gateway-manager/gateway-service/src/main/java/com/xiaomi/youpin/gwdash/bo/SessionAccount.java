...
public class SessionAccount {
    ...
    private List<GroupInfoEntity> gidInfos;
    ...
    public List<GroupInfoEntity> getGidInfos() {
        return gidInfos;
    }

    public void setGidInfos(List<GroupInfoEntity> gidInfos) {
    ...
    public SessionAccount(Long id, String username, String name, String token, Integer role, String gid, List<RoleBo> roles, List<GroupInfoEntity> gidInfos) {
        this.id = id;
        this.uuid = id;
        this.username = username;
        this.name = name;
    ...
    public SessionAccount(Long id, String username, String name, String token, Integer role, String gid, List<RoleBo> roles, List<GroupInfoEntity> gidInfos,List<ResourceBo> resources) {
        this.id = id;
        this.uuid = id;
        this.username = username;
        this.name = name;
