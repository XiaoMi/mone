...
@Slf4j
@Component
public class OuterApplyStep2Handler extends BaseHandler<ApplyOuterParam>{
    ...
    public OuterApplyStep2Handler() {
        super(ApplyTypeEnum.OUTER_APPLY_STEP2, NodeTypeEnum.PRO_TYPE);
    }
